...
import { Container, Row, OneThirdColumn, TwoThirdsColumn, Image } from "../components/atoms"
    ...
    <Layout>
      <section id="overview">
        <Container>
          <Row>
            <OneThirdColumn>
              <Image src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/cornflake-cake-f773778.jpg" title="image" alt="something about this" />
            </OneThirdColumn>
            ...
            <TwoThirdsColumn>
              ...
              <ul class="recipe-info">
                <li title="Servings">quantity<span>8-10 servings</span></li>
                <li title="Prep Time">prep time<span>20 min</span></li>
                <li title="Cook Time">cook time<span>40 min</span></li>
              </ul>
